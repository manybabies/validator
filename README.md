...
* Currently uses [ShinyValidator](https://github.com/manybabies/ShinyValidator) version: 2.0.5 (Sept 18, 2026)
...
Once the validator reports that your dataset is valid, it meets the requirements defined by the selected project specification and is ready for submission. The hidden **Download Validated CSV File** button will now appear; click the button to download a copy of the validated data, converted to a standardized format (i.e. comma-delimited). A prompt will appear for you to enter your labid. The generated file name will have the following naming scheme: "labID_Study_Format_CODE".

> **WARNING:** Do not alter the auto-generated file name or change any of the file contents after saving! The autogenerated code is an authenticator to show that this is a version-locked dataset that has passed validation.
